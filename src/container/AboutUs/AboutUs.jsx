    ...
    <div className="app__aboutus-content flex__center">
      <div className="app__aboutus-content_about">
        ...
        <p className="p__opensans">
          ...
          aliquam minima id nesciunt nisi itaque porro commodi est illo ipsam
          magni, laboriosam ea beatae repudiandae voluptatem natus asperiores
          consequuntur earum architecto. Ad, quos.
        </p>
